...
import { Comment, Tooltip, List, Avatar, Form, Input, Button, Icon, Skeleton, message } from 'antd';
...
class Detail extends Component {
  ...
  render() {
    const { comment, headings = [] } = this.state;
    const {
      home: {
        commentList = [],
        ...
        <Skeleton loading={detailLoading} active>
          ...
          <div className={styles.append} id="likesContainer">
            <Icon
              ...
              theme="twoTone"
              twoToneColor="#eb2f96"
              onClick={this.createReactionForIssue}
            />
        ...
        <Skeleton loading={commentLoading} active avatar>
          ...
          {isLogin ? (
            <Comment
              ...
              content={this.renderEditor(this.handleChange, this.handleSubmit, submitting, comment)}
            />
          ) : null}
        </Skeleton>
